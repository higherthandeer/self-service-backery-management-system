...
import { reqMemberReceipt } from '@/api/member'
import { ReceiptResponseData, Records } from '@/api/member/type.ts'
...
const getHasReceipt = async () => {
  let result: ReceiptResponseData = await reqMemberReceipt(
    pageNo.value,
    pageLimit.value,
  )
